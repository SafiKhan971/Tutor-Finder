                ...
                <div class="col-lg-9">
                    <div class="card border-0 shadow mb-4">
                        ...
                        <div class="card-body card-form">
                            <form action="{{ route('subject.update', $subject->id) }}" method="post" id="userForm"
                                name="userForm">
                                @csrf
                                        ...
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select" name="discipline_id" id="discipline_id">
                                                    ...
                                                    <option value="{{ $discipline->id }}" {{ $subject->discipline_id == $discipline->id ? 'selected' : '' }}> {{ $discipline->name }} </option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            @error('discipline_id')
