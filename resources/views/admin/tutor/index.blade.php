                    ...
                    <div class="card border-0 shadow mb-4">
                        ...
                        <div class="card-body card-form">
                            <div class="d-flex justify-content-between">
                                <div>
                                    <h3 class="fs-4 mb-1">Tutors</h3>
                                </div>
                                <div style="margin-top: -10px;">
                                    <a href="{{ route('tutor.create') }}" class="btn btn-primary">Add New Tutor</a>
                                </div>
                            </div>
                                        ...
                                        @if ($tutors->isNotEmpty())
                                            @foreach ($tutors as $index => $tutor)
                                                <tr class="active">
                                                    <td>{{ $index + 1 }}</td>
                                                    <td>
                                                        <div class="job-name fw-500">{{ $tutor->name }}</div>
                                                    </td>
                                                    <td>
                                                        <div class="info1">{{ $tutor->email }}</div>
                                                    </td>
                                                    <td>
                                                        <div class="info1">{{ $tutor->phone }}</div>
                                                    </td>
                                                    <td>
                                                        <div class="info1">{{ $tutor->gender }}</div>
                                                    </td>
                                                    <td>
                                                        @if($tutor->status == 1)
                                                        <div class="info1"><span class="badge badge-approved">Approved</span></div>
                                                        @elseif($tutor->status == 2)
                                                        <div class="info1"><span class="badge badge-rejected">Rejected</span></div>
                                                        @else
                                                        ...
                                                        <div class="action-dots ">
                                                            ...
                                                            <ul class="dropdown-menu dropdown-menu-end">
                                                                <li><a class="dropdown-item"
                                                                        href="{{ route('tutor.edit', $tutor->id) }}">
                                                                        <i class="fa fa-eye" aria-hidden="true"></i>
                                                                        Edit</a></li>
                                                                <li><a class="dropdown-item"
                                                                        href="{{ route('tutor.approve', $tutor->id) }}">
                                                                        <i class="fa fa-eye" aria-hidden="true"></i>
                                                                        Approve</a></li>
                                                                <li><a class="dropdown-item"
                                                                        href="{{ route('tutor.reject', $tutor->id) }}">
                                                                        <i class="fa fa-eye" aria-hidden="true"></i>
                                                                        Reject</a></li>
                                                                <li><a class="dropdown-item" href="#"
                                                                        onClick="deleteUser({{ $tutor->id }})"><i
