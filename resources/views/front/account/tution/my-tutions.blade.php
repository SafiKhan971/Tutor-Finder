                            ...
                            <table class="table ">
                                ...
                                @if($tutions->isNotEmpty())
                                    @foreach($tutions as $tution)
                                        ...
                                        <tr class="active">
                                            <td>
                                                <div class="job-name fw-500">{{ $tution->title}}</div>
                                                <div class="info1">Subject: {{$tution->category->name}}</div>
                                                
                                                <div class="info1">Class: {{$tution->classType->name}}</div>
                                                <div class="info1">Location: {{$tution->location}}</div>
                                            </td>
                                            <td>{{\Carbon\Carbon::parse($tution->created_at)->format('d M, Y')}}</td>
                                            ...
                                            <td>
                                                <div class="action-dots float-end">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end">
                                                        <li><a class="dropdown-item" href="{{route('tutionDetail', $tution->id)}}"> <i class="fa fa-eye" aria-hidden="true"></i> View</a></li>
                                                        <li><a class="dropdown-item" href="{{route('account.editTution', $tution->id)}}"><i class="fa fa-edit" aria-hidden="true"></i> Edit</a></li>
                                                        <li><a class="dropdown-item" href="#"  onClick="deleteTution({{$tution->id}})" ><i class="fa fa-trash" aria-hidden="true"></i> Remove</a></li>
                                                    </ul>
                                                </div>
                                            </td>
                                        </tr>
