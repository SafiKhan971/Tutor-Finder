        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-white shadow py-3 fixed-top">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <h5 class="ms-auto mt-3">Tutor Dashboard</h5>
                    ...
                    @php
                        $messageCount = \App\Models\Message::where('to_user', auth()->user()->id)
                            ...
                            ->count();
                    @endphp
                    <a class="btn btn-outline-primary ms-auto position-relative" href="{{ route('message.index') }}">
                    ...
                    {{-- My Account --}}
                    <a class="btn btn-outline-primary ms-3" href="{{ route('tutor.profile') }}" type="submit">My
                        Account</a>
