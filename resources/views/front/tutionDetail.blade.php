            ...
            <div class="col">
                <nav aria-label="breadcrumb" class=" rounded-3 p-3">
                    <ol class="breadcrumb mb-0">
                        <li class="breadcrumb-item"><a href="{{route('tutions')}}"><i class="fa fa-arrow-left" aria-hidden="true"></i> &nbsp;Back to Tutions</a></li>
                    </ol>
                </nav>
            </div>
        </div> 
                ...
                <div class="card shadow border-0">
                    ...
                    <div class="descript_wrap white-bg">
                        ...
                        <div class="pt-3 text-end">
                            ...
                            @if(Auth::check())
                            <a href="#" onClick="saveTution({{$tution->id}})" class="btn btn-primary">Save</a>
                            @else
                            ...
                            @if(Auth::check())
                            <a href="#" onClick="applyTution({{$tution->id}})" class="btn btn-primary">Apply</a>
                            @else
                            <a href="javascript:void(0)" class="btn btn-primary disabled">Login to Apply</a>
                            @endif
                        </div>
            ...
            <div class="col-md-4">
                <div class="card shadow border-0">
                    <div class="job_sumary">
                        ...
                        <div class="job_content pt-3">
                            <ul>
                                <li>Published on: <span>{{\Carbon\Carbon::parse($tution->created_at)->format('d M, Y')}}</span></li>
                                <li>Subject: <span> {{$tution->category->name}} </span></li>
                                <li>Class: <span> {{  $tution->classType->name}} </span></li>

                                <li>Students : <span>{{$tution->no_of_stu}}</span></li>
                                ...
                                <li>Location: <span>{{$tution->location}}</span></li>
                ...
                <div class="card shadow border-0 my-4">
                    <div class="job_sumary">
                        ...
                        <div class="job_content pt-3">
                            <ul>
                                <li>Name: <span>{{ $tution->gurdian_name }}</span></li>
                                @if(!is_null($tution->salary))
