    ...
    <div class="container">
        <div class="row">
            <div class="col-12 col-xl-8">
                <h1>Find your dream Tution</h1>
                <p>Thounsands of Tution available.</p>
        ...
        <div class="card border-0 shadow p-5">
            <div class="row">
                <div class="col-md-3 mb-3 mb-sm-3 mb-lg-0">
                    <input type="text" class="form-control" name="search" id="search" placeholder="Class">
                </div>
                <div class="col-md-3 mb-3 mb-sm-3 mb-lg-0">
        ...
        <div class="row pt-5">
            <div class="job_listing_area">                    
                <div class="job_lists">
                    ...
                    @if($featuredTutions->isNotEmpty())
                            @foreach($featuredTutions as $featuredTution)
                                   
                            <div class="col-md-4">
                                    <div class="card border-0 p-3 shadow mb-4">
                                        <div class="card-body">
                                            <h3 class="border-0 fs-5 pb-2 mb-0">{{$featuredTution->title}}</h3>
                                            <p>{{Str::words($featuredTution->description,7)}}</p>
                                            <div class="bg-light p-3 border">
                                                <p class="mb-0">
                                                    <span class="fw-bolder"><i class="fa fa-map-marker"></i></span>
                                                    <span class="ps-1">{{$featuredTution->location}}</span>
                                                </p>
                                                <p class="mb-0">
                                                    <span class="fw-bolder"><i class="fa fa-users"></i></span>
                                                    <span class="ps-1">{{$featuredTution->classType->name}}</span>
                                                </p>
                                              

                                                @if(!is_null($featuredTution->salary))
                                                <p class="mb-0">
                                                    <span class="fw-bolder"><i class="fa fa-usd"></i></span>
                                                    <span class="ps-1">{{$featuredTution->salary}}</span>
                                                </p>
                                            ...
                                            <div class="d-grid mt-3">
                                                <a href="{{route('tutionDetail',$featuredTution->id)}}" class="btn btn-primary btn-lg">Details</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-4">
                                    <div class="card border-0 p-3 shadow mb-4">
                                        <div class="card-body">
                                            ...
                                            <div class="d-grid mt-3">
                                                <a href="{{route('tutionDetail',$latestTution->id)}}" class="btn btn-primary btn-lg">Details</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
