    ...
    <section class="section-4 bg-2">
                ...
                <div class="col">
                    <nav aria-label="breadcrumb" class=" rounded-3 p-3">
                        <ol class="breadcrumb mb-0">
                            <li class="breadcrumb-item"><a href="{{ route('home') }}"><i class="fa fa-arrow-left"
                                        aria-hidden="true"></i> &nbsp;Back to Home</a></li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="container job_details_area">
            <div class="row pb-5">
                ...
                <div class="col-md-4">
                    <div class="card shadow border-0">
                        <div class="job_sumary mt-3">
                            <div class="text-center">
                                @if ($tutor->image != '')
                                    <img src="{{ asset('profile_pic/' . $tutor->image) }}" alt="avatar"
                                ...
                                @endif
                                <h4>{{ $tutor->name }}</h4>
                                <a href="{{ route('tution.create', $tutor_id) }}" class="btn btn-primary">Hire Tutor</a>
                            </div>

                            <div class="job_content pt-3 text-ce">
                                <ul>
                                    <li>Gender: <span> {{ $tutor->gender }} </span></li>
                                    <li>Type: <span> {{ $tutor->type }} </span></li>
                                    <li>Hourly Rate : <span>{{ $tutor->hourly_rate }} $ / Hour</span></li>
                                </ul>
                                <br>
                                <div class="d-flex">
                                    <button class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#bookDemoClass" type="button">Book Demo Class</button>
                                    <button class="btn btn-sm btn-secondary ms-2" data-bs-toggle="modal" data-bs-target="#sendMessage" type="button">Send Message</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card shadow border-0 my-4">
                        <div class="job_sumary">
                            ...
                            <div class="job_content pt-3">
                                <ul>
                                    <li>Email: <span>{{ $tutor->email }}</span></li>
                                    <li>Phone: <span>{{ $tutor->phone }}</span></li>
                                    <li>Address: <span>{{ $tutor->address }}</span></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-12">
                    <div class="card shadow border-0 my-4">
                        <div class="job_sumary">
                            ...
                            <div class="card shadow bg-2 mt-2">
                                <div class="d-flex align-items-center p-3">
                                    <!-- Image on the left -->
                                    <div class="image me-3">
                                        @if ($review->user->image != '')
                                            <img src="{{ asset('profile_pic/' . $review->user->image) }}" alt="avatar"
                                ...
                                <div class="review p-2">
                                    <p> <i class="fa fa-quote-left"></i> {{ $review->review }} <i class="fa fa-quote-right"></i></p>
                                </div>
                            </div>
                            @endforeach
                        </div>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title pb-0" id="exampleModalLabel">Write Review</h5>
                    ...
                    <div class="modal-body">
                        <form method="post" action="{{ route('rating.store') }}">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" name="review" id="review" style="height: 10rem;" placeholder="Write Here ..."
                                    required></textarea>
                                @error('review')
        ...
        <div class="modal fade" id="bookDemoClass" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title pb-0" id="exampleModalLabel">Book Demo Class</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
        ...
        <div class="modal fade" id="sendMessage" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title pb-0" id="exampleModalLabel">Send Message</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
